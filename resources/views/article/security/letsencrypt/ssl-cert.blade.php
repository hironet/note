...
<h2 id="create" class="heading color-heading">SSLサーバ証明書の作成</h2>
<p>1. 以下のコマンドを実行する。</p>
...
<h2 id="update" class="heading color-heading">SSLサーバ証明書の更新</h2>
<p>1. 以下のコマンドを実行する。</p>
...
<pre class="code-block"><code class="shell"># nslookup -type=txt _acme-challenge.[ドメイン名] 8.8.8.8</code></pre>
<p>8. Webサーバに設定ファイルを再読み込みさせる。</p>
<h2 id="delete" class="heading color-heading">SSLサーバ証明書の削除</h2>
<p>1. 以下のコマンドを実行する。</p>
