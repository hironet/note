...
<h3 class="heading bottomline-heading">エラー処理をエレガントに行う</h3>
...
<h3 class="heading bottomline-heading">ホスト名からドメイン部分を取り除く</h3>
...
<h3 class="heading bottomline-heading">ランダム文字列を生成する</h3>
...
<h3 class="heading bottomline-heading">実行スクリプトのファイル名を除いた絶対パスを取得する</h3>
<pre class="code-block"><code class="bash">script_dir=$(cd $(dirname $0); pwd)</code></pre>
<h3 class="heading bottomline-heading">関数の呼び出し元に文字列を返す</h3>
<ul>
...
<h3 class="heading bottomline-heading">更新日時が3日前以前（72時間前～過去）のファイルを削除する</h3>
<pre class="code-block"><code class="bash">find [ディレクトリパス] -type f -mtime +3 -exec rm -f {} \;</code></pre>
<h3 class="heading bottomline-heading">更新日時が新しい2つのファイルについて、差分を確認する</h3>
...
<h3 class="heading bottomline-heading">ファイルの末尾100行のみ残し、それ以前の行を削除する</h3>
...
<h3 class="heading bottomline-heading">ファイルの内容をソートし、元のファイルに結果を出力する</h3>
...
interact
"</code></pre>
<h3 class="heading bottomline-heading">デーモンとして動作するプログラムを起動・停止する</h3>
...
<h3 class="heading bottomline-heading">ループカウンタを使う</h3>
...
<h3 class="heading bottomline-heading">変数の値が空だった場合に値を設定する</h3>
