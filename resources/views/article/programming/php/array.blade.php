...
<h4 class="heading bottomline-heading">短縮構文で空の配列を作成する</h4>
<pre class="code-block"><code class="php">$colors = [];</code></pre>
<h3 class="heading lowerleftline-heading">1次元配列の作成・初期化（添字配列の場合）</h3>
...
<h4 class="heading bottomline-heading">短縮構文で添字配列を作成・初期化する</h4>
<pre class="code-block"><code class="php">$colors = ['red', 'green', 'blue'];
echo $colors[2], PHP_EOL;  # blue</code></pre>
<h3 class="heading lowerleftline-heading">1次元配列の作成・初期化（連想配列の場合）</h3>
<h4 class="heading bottomline-heading">array()で連想配列を作成・初期化する</h4>
...
<h3 class="heading lowerleftline-heading">2次元配列の作成・初期化（連想配列の場合）</h3>
<h4 class="heading bottomline-heading">array()で連想配列を作成・初期化する</h4>
...
<h4 class="heading bottomline-heading">連想配列の値を文字列内に展開する</h4>
<pre class="code-block"><code class="php">$product = ['product_no' => 11, 'product_name' => 'iPhone 12', 'price' => 94380];
...
<h4 class="heading bottomline-heading">配列の1番目と2番目の要素のみ変数に代入する</h4>
<pre class="code-block"><code class="php">$colors = ['red', 'green', 'blue'];
list($color_1, $color_2) = $colors;
echo $color_1, PHP_EOL;  # red
echo $color_2, PHP_EOL;  # green</code></pre>
<h4 class="heading bottomline-heading">配列の1番目と3番目の要素のみ変数に代入する</h4>
<pre class="code-block"><code class="php">$colors = ['red', 'green', 'blue'];
list($color_1, , $color_3) = $colors;
echo $color_1, PHP_EOL;  # red
echo $color_3, PHP_EOL;  # blue</code></pre>
<h4 class="heading bottomline-heading">配列の3番目の要素のみ変数に代入する</h4>
<pre class="code-block"><code class="php">$colors = ['red', 'green', 'blue'];
list(, , $color_3) = $colors;
echo $color_3, PHP_EOL;  # blue</code></pre>
<h3 class="heading lowerleftline-heading">配列の分解（短縮構文の場合）</h3>
<h4 class="heading bottomline-heading">配列から複数の変数に代入する</h4>
<pre class="code-block"><code class="php">$colors = ['red', 'green', 'blue'];
