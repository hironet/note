...
<h3 class="heading desc">GUIパッケージをインストールする</h3>
...
<h3 class="heading desc">Homebrew本体とFormulaを更新する</h3>
<pre class="code-block"><code class="shell"># brew update</code></pre>
<h3 class="heading desc">バージョンが古くなったパッケージ一覧を表示する</h3>
...
<h3 class="heading desc">インストールされている全てのGUIパッケージを更新する</h3>
...
<h3 class="heading desc">Homebrewの問題を診断する</h3>
