...
<h3 class="oper">yumでDVDからパッケージをインストールする</h3>
...
<h3 class="oper">システムの時刻・日付設定を確認する</h3>
