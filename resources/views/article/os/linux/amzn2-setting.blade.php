...
<h2 id="swap" class="heading bgcolor-heading">スワップ領域の設定</h2>
<h3 class="heading bottomline-heading">スワップ領域を作成する</h3>
...
<h2 id="hostname" class="heading bgcolor-heading">ホスト名の設定</h2>
<p>1. ホスト名の設定を確認する。</p>
...
<pre class="code-block"><code class="shell"># hostnamectl status</code></pre>
<h2 id="locale" class="heading bgcolor-heading">ロケールの設定</h2>
<p>1. ロケールの設定を確認する。</p>
...
<pre class="code-block"><code class="shell"># localectl status</code></pre>
<h2 id="timezone" class="heading bgcolor-heading">タイムゾーンの設定</h2>
