...
<h3 class="heading bottomline-heading">未使用のデータボリュームを削除する</h3>
<pre class="code-block"><code class="shell">$ docker volume prune</code></pre>
<h3 class="heading bottomline-heading">データボリュームをコンテナ内のディレクトリにマウントする</h3>
...
<h3 class="heading bottomline-heading">ホストOSのディレクトリをコンテナ内のディレクトリに読み取り専用でマウントする</h3>
