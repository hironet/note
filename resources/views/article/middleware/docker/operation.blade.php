...
<h3 class="heading underline-heading">コンテナ稼働状態確認</h3>
<h4 class="heading desc">稼働中のコンテナを確認する</h4>
<pre class="code-block"><code class="shell">$ docker ps</code></pre>
<h4 class="heading desc">停止中のコンテナも含め、全てのコンテナを確認する</h4>
<pre class="code-block"><code class="shell">$ docker ps -a</code></pre>
<h3 class="heading underline-heading">コンテナ作成</h3>
<h4 class="heading desc">コンテナを作成し、起動する</h4>
<pre class="code-block"><code class="shell">$ docker run -itd --name [コンテナ名] [イメージ名]</code></pre>
<h3 class="heading underline-heading">コンテナ削除</h3>
<h4 class="heading desc">コンテナを削除する</h4>
<pre class="code-block"><code class="shell">$ docker rm [コンテナID]</code></pre>
<h4 class="heading desc">起動しているコンテナを削除する</h4>
<pre class="code-block"><code class="shell">$ docker rm -f [コンテナID]</code></pre>
<h4 class="heading desc">停止している全てのコンテナを削除する</h4>
<pre class="code-block"><code class="shell">$ docker container prune</code></pre>
<h4 class="heading desc">全てのコンテナを削除する</h4>
<pre class="code-block"><code class="shell">$ docker rm -f $(docker ps -a -q)</code></pre>
<h4 class="heading desc">ステータスが「Exited」のコンテナを削除する</h4>
<pre class="code-block"><code class="shell">$ docker rm $(docker ps -a -f "status=exited" -q)</code></pre>
<h3 class="heading underline-heading">コンテナ起動</h3>
<h4 class="heading desc">コンテナを起動する</h4>
<pre class="code-block"><code class="shell">$ docker start [コンテナID]</code></pre>
<h3 class="heading underline-heading">コンテナ停止</h3>
<h4 class="heading desc">コンテナを停止する</h4>
<pre class="code-block"><code class="shell">$ docker stop [コンテナID]</code></pre>
<h3 class="heading underline-heading">コンテナ再起動</h3>
<h4 class="heading desc">コンテナを再起動する</h4>
<pre class="code-block"><code class="shell">$ docker restart [コンテナID]</code></pre>
<h3 class="heading underline-heading">コンテナへのログイン</h3>
<h4 class="heading desc">コンテナにログインする</h4>
