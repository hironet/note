...
<table class="table table-striped table-sm">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><code>yum -y install [パッケージ名]</code></td>
    </tr>
    <tr>
      <td>パッケージをアンインストールする。</td>
      <td><code>yum remove [パッケージ名]</code></td>
    </tr>
    <tr>
...
<table class="table table-striped table-sm">
  ...
  <tbody>
    <tr>
      <td>サービス一覧を表示する。</td>
      <td><code>systemctl list-unit-files -t service</code></td>
    </tr>
    <tr>
      <td>サービスの状態を確認する。</td>
      <td><code>systemctl status [unit名]</code></td>
    </tr>
    <tr>
      <td>サービスを起動する。</td>
      <td><code>systemctl start [unit名]</code></td>
    </tr>
    <tr>
      <td>サービスを停止する。</td>
      <td><code>systemctl stop [unit名]</code></td>
    </tr>
    <tr>
      <td>サービスを再起動する。</td>
      <td><code>systemctl restart [unit名]</code></td>
    </tr>
    <tr>
      <td>サービスの自動起動を有効化する。</td>
      <td><code>systemctl enable [unit名]</code></td>
    </tr>
    <tr>
      <td>サービスの自動起動を無効化する。</td>
      <td><code>systemctl disable [unit名]</code></td>
    </tr>
  </tbody>
</table>
