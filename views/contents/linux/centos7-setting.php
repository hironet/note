...
<pre class="block"><code>$ nmcli c modify [ネットワークインタフェース名] ipv4.addresses [IPアドレス]/[サブネットマスク]</code></pre>
<p>デフォルトゲートウェイを設定する。</p>
<pre class="block"><code>$ nmcli c modify [ネットワークインタフェース名] ipv4.gateway [デフォルトゲートウェイのIPアドレス]</code></pre>
<p>スタティックルートを設定する。</p>
<pre class="block"><code>$ nmcli c modify [ネットワークインタフェース名] ipv4.routes "[宛先ネットワークのアドレス]/[サブネットマスク] [ゲートウェイのIPアドレス]"</code></pre>
...
<pre class="block"><code>$ nmcli c modify [ネットワークインタフェース名] ipv4.dns [DNSサーバのIPアドレス]</code></pre>
<p>IPアドレスを固定割り当てに設定する。</p>
<pre class="block"><code>$ nmcli c modify [ネットワークインタフェース名] ipv4.method manual</code></pre>
