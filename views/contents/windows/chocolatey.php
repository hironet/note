  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      <tr>
        ...
        <td><pre class="inline"><code>&gt; choco list -l</code></pre></td>
      </tr>
      <tr>
        <td>パッケージ情報を検索する。</td>
        <td><pre class="inline"><code>&gt; choco list [パッケージ名]</code></pre></td>
      </tr>
      <tr>
        <td>パッケージをインストールする。</td>
        <td><pre class="inline"><code>&gt; choco install -y [パッケージ名]</code></pre></td>
      </tr>
      <tr>
        <td>パッケージをアンインストールする。</td>
        <td><pre class="inline"><code>&gt; choco uninstall [パッケージ名]</code></pre></td>
      </tr>
      <tr>
        <td>インストールされている全てのパッケージを更新する。</td>
        <td><pre class="inline"><code>&gt; choco upgrade -y all</code></pre></td>
      </tr>
      <tr>
        <td>インストールされている個別のパッケージを更新する。</td>
        <td><pre class="inline"><code>&gt; choco upgrade -y [パッケージ名]</code></pre></td>
      </tr>
    </tbody>
  </table>
</div>
...
<pre class="block"><code>&gt; choco install -y choco.config</code></pre>
<pre class="block"><code>&gt; &lt;?xml version="1.0" encoding="utf-8"?&gt;
&lt;packages&gt;
  &lt;package id="7zip" /&gt;
